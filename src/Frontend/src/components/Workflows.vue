...
// Static page for the Klassd.Workflows package. Content lives here (not in the CMS) so it's
// versioned with the site and renders with zero CMS dependency — it prerenders into
// /workflows/index.html. Reuses the shared `docs-*` styles from style.css.
    ...
    <article class="docs-body">
      <header class="docs-head">
        ...
        <p class="docs-lede-meta">
          A companion to <a href="/">Klassd</a>, the code-first headless CMS — same philosophy, separate package.
        </p>
      </header>
