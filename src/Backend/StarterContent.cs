...
public static class StarterContent
{
    public static async Task SeedAsync(IServiceProvider services)
    {
        ...
        await globals.SaveAsync(nameof(SiteHeader), locale,
            ...
            {
                ["logoText"] = "Klassd",
                // Primary nav: on-site docs, the Workflows package page, + a link out to the GitHub repo.
                ["navLinks"] = """[{"label":"Docs","url":"/docs"},{"label":"Workflows","url":"/workflows"},{"label":"GitHub","url":"https://github.com/getklassd/Klassd"}]""",
                ["ctaText"] = "GitHub",
                ["ctaUrl"] = "https://github.com/getklassd/Klassd",
            },
            blockAreas: null);
        ...
        await globals.SaveAsync(nameof(SiteFooter), locale,
            ...
            new Dictionary<string, List<BlockData>>
            {
                ...
                [
                    ...
                    {
                        ["heading"] = "Project",
                        ["links"] = """[{"label":"GitHub","url":"https://github.com/getklassd/Klassd"},{"label":"Docs","url":"/docs"},{"label":"Workflows","url":"/workflows"},{"label":"NuGet","url":"https://www.nuget.org/profiles/getklassd"}]""",
                    }),
                ],
            });
    }
